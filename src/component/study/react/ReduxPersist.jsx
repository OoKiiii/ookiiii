      ...
      <div className="description-box">
        ...
        <span className="explain-box">
          <span className="explain">
            현재 페이지에서 보이는 좌측메뉴는 redux를 사용해서 json파일에 있는 리스트를 불러오는 형식으로 작업이 되어있다.
            <br />
...
serviceWorker.unregister()
        ...
        <span className="explain-box">
          <span className="explain">
            이렇게 하면 로컬스토리지에 저장이 되면서 새로고침을 해도 메뉴가 사라지지 않는다.
          </span>
        </span>

        <span className="explain-box">
          <span className="explain">
            출처 : <a href="https://kyounghwan01.github.io/blog/React/redux/redux-persist/#%E1%84%89%E1%85%A5%E1%86%AF%E1%84%8E%E1%85%B5" target="_blank">https://kyounghwan01.github.io/blog/React/redux/redux-persist/#%E1%84%89%E1%85%A5%E1%86%AF%E1%84%8E%E1%85%B5</a>
          </span>
        </span>
